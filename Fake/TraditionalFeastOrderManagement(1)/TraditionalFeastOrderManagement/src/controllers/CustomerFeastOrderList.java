 ...
 * @author ADMIN
 */
public class CustomerFeastOrderList extends ArrayList<CustomerFeastOrder> implements I_List {
...
//                for (Object obj : listSetCode) {
//                    if (obj instanceof Feast && ((Feast) obj).getCodeOfSetMenu().equalsIgnoreCase(setCode)) {
//                        feast = (Feast) obj;
//                        break;
//                    }
//                }
...
//    }
    @Override
    public boolean placeFeastOrder(String customerCode) {
        boolean check = false;
        try {
            ...
            // 6 Kiểm tra trùng lặp đơn hàng
            if (isDupliOrder(customerCode, setCode, eventDate)) {
            ...
            System.out.println("Price per table : " + feast.getPrice() + " VND");
            System.out.println("Ingredients:");
            for (String line : feast.getIngrediends().split("#\\+")) {
    ...
    Customer getCustomerByCode(String customerCode) {
        ...
        return this.get(index).getCustomer(); // Trả về khách hàng nếu tìm thấy
    }
