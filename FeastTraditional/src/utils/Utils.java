...
public class Utils {
    ...
    public static boolean isFutureDate(Date date) {
        ...
        return inputDate.isAfter(today); // Kiểm tra nếu ngày đầu vào là sau ngày hôm nay
    }
...
//    }
    ...
    public Customer inputCustomerInfo(boolean isUpdate) {
        ...
        if (!isUpdate) {
            do {
                String code = getString("Enter customer CODE (C, G, K followed by 4 digits): ").toUpperCase();
                if (isValidCode(code)) {
        ...
        do {
            String email = getString("Enter EMAIL of customer: ");
    ...
    public OrderFeast inputOrderFeast(boolean isUpdate) {
        ...
        if (!isUpdate) {
            ...
            // Nhập số bàn
            do {
                String numTable = getString("Enter number of tables: ");
                int numTable2 = Integer.parseInt(numTable);
                if (numTable2 > 0) {
                    orderFeast.setNumTable(numTable);
                    break;
                } else if (numTable2 < 99999) {
                    System.out.println("Invalid number of tables! Maximun is 500.");
                } else {
